...
class ResponsiveApp:
    ...
    def open_add_file_window(self):
        ...
        choices = ["Info@santhigirifoundation.com", "projectcellos@gmail.com"]
        ...
        def on_selection_change(event):
         print('SEL===')
         selection = event.branch_dropdown.get()
         print('SEL1===', selection)

# Bind the callback to the dropdown
         branch_dropdown.bind("<<ComboboxSelected>>", on_selection_change)
        ##########################          
